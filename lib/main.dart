...
import 'package:qatra_app/helper/providers/reset_provider.dart';
import 'package:qatra_app/utils/routes.dart';
import 'package:qatra_app/screens/splash.dart';

import 'components/loading.dart';
import 'helper/providers/profile_provider.dart';
        ...
        if (snapshot.connectionState == ConnectionState.done)  {
          ...
          return MultiProvider(
            providers: [
              ...
              ChangeNotifierProvider<NewUserProvider>(
              ...
              ChangeNotifierProvider<ResetProvider>(
                create: (context) => ResetProvider(),
              ),
            ],
            child: ScreenUtilInit(
                designSize: Size(392.72, 803.63),
                builder: () => GetMaterialApp(
                      ...
                      routes: routes,
                      navigatorKey:
                          NavigationService.navigationService.navigatorKey,
...
// Get.bottomSheet(CustomGridView());
//      },),)
//    );
//   }
// }
