...
List<String> gender = ["انثى","ذكر"];

void addToastMessage({String error,bool type}) {
  Fluttertoast.showToast(
      msg: error,
      toastLength: Toast.LENGTH_SHORT,
      gravity: ToastGravity.CENTER,
      timeInSecForIosWeb: 1,
      backgroundColor: type?Colors.white:Colors.red,
      textColor: type?Colors.black:Colors.white,
      fontSize: 16.0);
}
